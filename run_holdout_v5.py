...
Usage:
    python3 run_holdout_v5.py [--smoke F001]
"""
...
SCENARIO_DIR = Path("scenarios/holdout_v5")
RESULTS_FILE = Path(f"results/v5_holdout_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json")
